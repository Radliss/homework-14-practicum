...
const myInformation = ['Lina', 12, 11, 'scorpion']
...
const sevenCountries = countries.shift()
...
let russianCities2 = ['Санкт-Петербург', 'Москва', ...russianCities];
console.log(russianCities2);
...
function sumElements(numbers) {
    ...
    const lastElement = numbers.length;
